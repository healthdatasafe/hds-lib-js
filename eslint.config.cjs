...
module.exports = [
  // Ignore patterns
  {
    ignores: [
      ...
      'dist/**',
      '**/*.cjs',
      // Generated by `npm run build:validators` from appTemplate.schema.json — Ajv's
      // standalone output is one long machine-written line and trips ~5k style rules.
      // Its correctness is guarded by tests/validatorDrift.test.js, not by the linter.
